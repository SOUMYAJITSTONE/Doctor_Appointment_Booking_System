...
>>>>>>> Stashed changes
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  So you can find a better location on your area and book an
                  hostpital accordingly.
                </p>
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px]
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Book an appointment for the first time with a your favourite
                  doctor and get a face to face call from them.
                </p>
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px]
...
=======
              <ul className="pl-4">
                ...
                <li className="text_para">
                  ...
                  online scheduling tool to select an appointmnet time.
                </li>
>>>>>>> Stashed changes
              </ul>
              <Link to="/">
